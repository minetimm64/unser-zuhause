...
const SMAP={schlafzimmer:'Schlafzimmer',wohnzimmer:'Wohnzimmer',kueche:'Kueche',bad:'Bad',flur:'Flur',balkon:'Balkon',keller:'Keller'};
...
function saveGame(){
  try{
    const data={hunger:GS.hunger,dirtiness:GS.dirtiness,quests:GS.quests,room:GS.room,kellerUnlocked:GS.kellerUnlocked,savedAt:Date.now()};
...
new Phaser.Game({
  ...
  scene:[StartScreen,Schlafzimmer,Wohnzimmer,Kueche,Bad,Flur,Balkon,Keller,UI]
});
